...
namespace P06TargetPractice
{
    internal class TargetPractice
    {
        ...
        static void Collapse(char[][] matrix)
        {
        ...
        static void Shoot(char[][] matrix, int[] target)
        {
        ...
        static void GetMatrix(char[][] matrix, int cols, string snake)
        {
            int counter = 0;
        ...
        static int SetLetter(char[][] matrix, string snake, int counter, int row, int col)
        {
