    ...
    internal class ParkingSystem
    {
        static void Main(string[] args)
        {
            ...
            while (input != "stop")
            {
                ...
                if (parkingSpots[targetRow].Contains(targetCol) == false)
                {
                ...
                else
                {
                    ...
                    while (true)
                    {
                        ...
                        if (parkingSpots[targetRow].Contains(steps) == false && steps > 0)
                        {
                        ...
                        if (parkingSpots[targetRow].Contains(steps) == false && steps < cols)
                        {
                            parkingSpots[targetRow].Add(steps);
